...
export interface Session { id: string; title: string; createdAt: string; updatedAt: string; messages: Message[]; model?: string; thinkingLevel?: ThinkingLevel; compaction?: SessionCompaction; directories?: string[]; cwd?: string; addDirInitialized?: boolean; parentSessionId?: string; agentType?: string; agentDescription?: string; agentStatus?: "running" | "complete" | "error" | "stopped"; planningTasks?: PlanningTask[]; planningTaskArchiveHighWaterMark?: number; contextTokens?: number; cacheUsage?: CacheUsage; cacheUsageResetThroughMessageId?: string; planMode?: SessionPlanMode; chatMode?: boolean; skillRoots?: string[]; skillTouchedPaths?: string[]; invokedSkills?: InvokedSkill[]; goal?: string; goalSetAt?: string }
