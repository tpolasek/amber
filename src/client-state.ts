...
export const elements = {
  ...
  cacheMeter: required<HTMLElement>("cache-meter"),
  cacheMeterBar: required<HTMLElement>("cache-meter-bar"),
  cacheMeterValue: required<HTMLElement>("cache-meter-value"),
  ...
  goalButton: required<HTMLButtonElement>("goal-button"),
  goalDialog: required<HTMLElement>("goal-dialog"),
  goalDialogBody: required<HTMLElement>("goal-dialog-body"),
  goalClose: required<HTMLButtonElement>("goal-close"),
  goalClear: required<HTMLButtonElement>("goal-clear"),
  goalContinue: required<HTMLButtonElement>("goal-continue"),
