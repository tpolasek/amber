...
A repository can also ship its own **AGENTS.md**; Amber reads the nearest one from the session's working directory upward and appends it after the user block in a **<project-instructions>** block (skipping the global file).
