...
- `src/client.ts` — responsive browser terminal with a dedicated transcript scroll viewport, session navigation, SSE stream handling, and lightweight safe Markdown rendering.
